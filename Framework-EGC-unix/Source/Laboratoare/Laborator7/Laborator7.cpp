...
void Laborator7::Init()
{
	...
	// Create a shader program for drawing face polygon with the color of the normal
	{
		...
		shader->AddShader("Resources/Shaders/Lab7VertexShader.glsl", GL_VERTEX_SHADER);
		shader->AddShader("Resources/Shaders/Lab7FragmentShader.glsl", GL_FRAGMENT_SHADER);
...
{
	{
		...
		RenderSimpleMesh(meshes["sphere"], shaders["ShaderLab7"], modelMatrix, glm::vec3(1.f, 0.f, 0.f));
	}

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.439216f, 0.858824f, 0.858824f));
	}

	{
		...
		RenderSimpleMesh(meshes["box"], shaders["ShaderLab7"], modelMatrix, glm::vec3(0.6f, .196078f, 0.8f));
	}
	...
	// Render ground
	{
		...
		RenderSimpleMesh(meshes["plane"], shaders["ShaderLab7"], modelMatrix, glm::vec3(.5f, 1.f, 0.f));
	}
